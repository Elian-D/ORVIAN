<x-public-layout :title="'Error del sistema | ' . config('app.name')">
    <div class="min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        <div class="mt-[-2rem] mb-6 w-16 h-16 rounded-2xl bg-orvian-orange/10 flex items-center justify-center">
            <x-heroicon-o-exclamation-triangle class="w-8 h-8 text-orvian-orange" />
        </div>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white mb-2">Error del sistema</h1>
        <p class="text-slate-500 dark:text-slate-400 max-w-md leading-relaxed mb-8">
            Algo salió mal. El equipo fue notificado. Intenta de nuevo en unos minutos.
        </p>
