@php
    ...
    // Asumiendo que esta variable viene del controlador o un provider, 
    // de lo contrario puedes hardcodearla como '1.0.0'
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div class="md:col-span-8 lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="{{ route('landing') }}#inicio" class="text-sm text-slate-500 hover:text-orvian-orange transition-colors">Inicio</a></li>
                        <li><a href="{{ route('landing') }}#modulos" class="text-sm text-slate-500 hover:text-orvian-orange transition-colors">Módulos</a></li>
                        <li><a href="{{ route('landing') }}#precios" class="text-sm text-slate-500 hover:text-orvian-orange transition-colors">Precios</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="https://wa.me/18296257463?text={{ $waMessage }}" target="_blank" class="text-sm text-slate-500 hover:text-orvian-orange transition-colors font-semibold">Solicitar demo</a></li>
                        <li><a href="{{ route('landing') }}#faq" class="text-sm text-slate-500 hover:text-orvian-orange transition-colors">Preguntas frecuentes</a></li>
                        <li><a href="{{ route('login') }}" class="text-sm text-slate-500 hover:text-orvian-orange transition-colors">Acceso institucional</a></li>
                    </ul>
                </div>
