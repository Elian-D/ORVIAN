        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-1 sm:gap-2">
                ...
                <div class="relative" x-data="{ open: false }">
                    @php
                        $parts    = explode(' ', Auth::user()->name ?? 'Usuario');
                    ...
                    <button @click="open = !open"
                        ...
                        <div class="w-8 h-8 rounded-full bg-orvian-orange flex items-center justify-center text-white text-xs font-black shadow-sm flex-shrink-0">
                            {{ $initials }}
                        </div>
                    ...
                    <div x-show="open"
                        ...
                        <div class="px-3 py-2.5 mb-1 border-b border-slate-100 dark:border-white/5">
                            <p class="text-sm font-semibold truncate text-slate-800 dark:text-slate-100">
                                {{ Auth::user()->name ?? 'Usuario' }}
                            </p>
                            <p class="text-xs truncate mt-0.5 text-slate-400 dark:text-slate-500">
                                {{ Auth::user()->email ?? '' }}
                            </p>
                        </div>
