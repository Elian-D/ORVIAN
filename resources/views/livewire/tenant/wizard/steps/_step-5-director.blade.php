                <div x-show="$wire.step === 5" style="display:none;" class="space-y-6">
                    ...
                    <div class="flex items-start gap-3 px-4 py-3.5 rounded-xl bg-amber-500/5 border border-amber-500/15">
                        ...
                        <p class="text-xs text-amber-400/80">Tu sesión como {{ auth()->user()->getRoleNames()->first() ?? 'Usuario' }} se mantendrá activa. El director podrá acceder con sus propias credenciales desde el login.</p>
                    </div>
