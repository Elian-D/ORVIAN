    ...
    <div class="w-full max-w-sm pb-3">
        <template x-for="(toast, i) in cascadeToasts" :key="toast.id">
            <div x-data="toastItem(toast)"
                 ...
                 @touchend="onSwipeEnd()"
                 class="relative w-full overflow-hidden rounded-xl border-l-[3px] bg-white dark:bg-dark-card"
                ...
                <div class="absolute bottom-0 left-0 w-full h-1 bg-black/5 dark:bg-white/10" x-show="open">
