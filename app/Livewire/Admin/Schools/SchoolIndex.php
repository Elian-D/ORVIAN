...
class SchoolIndex extends DataTable
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.schools.index', [
            'schools' => $schools,
            'plans'   => \App\Models\Tenant\Plan::orderBy('price')
                            ->where('is_active', true)
                            ->get(['id', 'name', 'price', 'text_color']),
    ...
    public function getStatsProperty(): array
    {
        ...
        // Obtenemos los IDs de las escuelas filtradas para usar en subconsultas
        $schoolIds = (clone $baseQuery)->select('id');
